...
export const AuthProvider = ({ children }) => {
  ...
  const loginDemo = useCallback(async (userRole = 'farmer') => {
    const demoEmail = userRole === 'admin'
      ? 'demo-admin@gramsight.ai'
      : 'demo-farmer@gramsight.ai';
    try {
      ...
      // Fallback to legacy offline demo mode
      localStorage.setItem('gs_role', userRole);
      setRole(userRole);
      setToken('demo');
    }
